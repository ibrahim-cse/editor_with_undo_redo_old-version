...
class _FlutterPainterExampleState extends State<FlutterPainterExample> {
  ...
  void renderAndSaveImage() async {
    ...
    // final file1 = File('${extdir[0].path}/img.txt');
    // file1.writeAsString('hello world');
  ...
  void flipSelectedImageDrawable() {
    ...
    controller.replaceDrawable(
        imageDrawable, imageDrawable.copyWith(locked: !imageDrawable.locked));
  }
}
...
class RenderedImageDialog extends StatelessWidget {
  ...
  RenderedImageDialog({this.imageFuture});
